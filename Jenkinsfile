...
pipeline {
    ...
    environment {
        author_name = "Adeem Adil Khatri"
        author_email = "adil.khatri@ug.bilkent.edu.tr"
        app_name = "demo_project_eosc"
        job_location = "Pipeline-as-code/DEEP-OC-org/UC-adeemadil-DEEP-OC-demo_project_eosc/${env.BRANCH_NAME}"
    }
